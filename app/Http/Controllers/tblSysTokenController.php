...
class tblSysTokenController extends Controller
{
    public function index()
    {
        $data = DB::table('tbl_sys_tokens')   
        ->get(); 
    ...
    {
        $data = tblSysToken::findOrFail($id);
    ...
    {
        $userData = tblSysToken::where('user_id',$request->user_id)
