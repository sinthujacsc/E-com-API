                            ...
                            <table border="0"  cellspacing="0" width="100%">
                              <tr>
                                <td align="center" valign="top" class="textContent">
                                  <h6 style="margin-top:15px;color:#FFFFFF;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:25px;font-weight:normal;margin-bottom:15px;text-align:center;">You got a new enquiry</h6>
                                </td>
                              </tr>
                            </table>
                          </td>
                                  ...
                                  <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                      <td valign="top" class="textContent">
                                        ...
                                        <p>You got a new enquiry from <b>name</b> regarding <b>Subject</b>. Find the details below,</p></div>
