                            ...
                            <table border="0"  cellspacing="0" width="100%">
                              <tr>
                                <td align="center" valign="top" class="textContent">
                                  <h6 style="margin-top:15px;color:#FFFFFF;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:25px;font-weight:normal;margin-bottom:15px;text-align:center;">Your Password Successfully Updated</h6>
                                </td>
                              </tr>
                            </table>
                          </td>
                                  ...
                                  <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                      <td valign="top" class="textContent">
                                        <h3 style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;">Dear {{$obj->title}} {{$obj->firstName}} {{$obj->lastName}}</h3>
                                       
                                        <div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top:3px;color:#5F5F5F;line-height:135%;"><p>This message is to confirm that your ECom account password has been successfully changed. </p>

                                        <p>If you did not request a password change, please contact us immediately..</p>


                                            <p>Thank you,<br>The ECom Team</p></div>
                                        </td>
                                    </tr>
                                  </table>
                                  ...
                                  <table border="0" cellpadding="0" cellspacing="0" width="50%" class="emailButton" style="background-color: #2E7D32;">
                                    <tr>
                                      <td align="center" valign="middle" class="buttonContent" style="padding-top:15px;padding-bottom:15px;padding-right:15px;padding-left:15px;">
                                        <a style="color:#FFFFFF;text-decoration:none;font-family:Helvetica,Arial,sans-serif;font-size:20px;line-height:135%;" href="http://localhost:5200/" target="_blank">Login</a>
                                      </td>
                                    </tr>
                                  </table>
